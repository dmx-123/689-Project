...
x1=0;
a = 8.; % length of bar in x-direction
x2=a;

T = 1200.; % length of time for solution

n = 99;   % no of grid points Xn
m = 12000.;
...
beta = 21.5/(8000*510); % thermal diffusivity constant
...
U_tk = 200*ones(n+1,1); %2.*x + sin(2*pi*x) + 1.;
